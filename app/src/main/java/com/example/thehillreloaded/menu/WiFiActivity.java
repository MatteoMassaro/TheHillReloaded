...
public class WiFiActivity extends Animazioni {

    //variabili
    Button  cerca;
    public static Button gioca;
    ImageView indietro;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gioca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(WiFiActivity.this, SchermataCaricamentoActivity.class);
                startActivity(i);
            }
        });
        ...
        indietro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(WiFiActivity.this, MultigiocatoreActivity.class);
                startActivity(i);
            }
        });
